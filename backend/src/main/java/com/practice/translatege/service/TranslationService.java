...
import com.practice.translatege.api.model.Translation;
...
import static com.practice.translatege.service.TranslationAccess.askTranslateGe;
...
public class TranslationService {
    ...
    public TranslationService(String englishWord) {
    ...
    public String parseOutput() {
        ...
        System.out.println("TranslationService: output - " + translationOutput);

        if (StringUtils.isEmpty(translationOutput)) {
            System.out.println("TranslationService Cannot Translate");
